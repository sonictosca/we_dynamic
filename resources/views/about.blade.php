              ...
              <div id="people">
                ...
                <div class="media hidden-sm hidden-xs">
                  ...
                  <div class="row hidden-md hidden-lg">
                      <div class="col-md-4">
                          <img class="img-responsive" src="assets/img/stefano.jpg" alt="Stefano Capellini">
                      </div>
                      <div class="col-md-8">
                          <h3>Stefano Capellini</h3>
                      </div>
                      <div class="col-md-12">
                          <p>
                              Founder di We Can Group, ha ispirato la filosofia aziendale e può essere considerato un veterano del settore
                ...
                <div class="media hidden-sm hidden-xs">
                  ...
                  <div class="row hidden-md hidden-lg">
                      <div class="col-md-4">
                          <img class="img-responsive" src="assets/img/alessandra.jpg" alt="Alessandra Hormann">
                      </div>
                      <div class="col-md-8">
                          <h3>Alessandra Hofmann</h3>
                      </div>
                      <div class="col-md-12">
                          <p>
                              Unica donna dell'area manager, Alessandra, oltre a "sopportare" gli uomini del team
                ...
                <div class="media hidden-sm hidden-xs">
                  ...
                  <div class="row hidden-md hidden-lg">
                      <div class="col-md-4">
                          <img class="img-responsive" src="assets/img/daniele.jpg" alt="Daniele Maggioni">
                      </div>
                      <div class="col-md-8">
                          <h3>Daniele Maggioni</h3>
                      </div>
                      <div class="col-md-12">
                          <p>
                              Manager, stratega e "scrittore".
                ...
                <div class="media hidden-sm hidden-xs">
                  ...
                  <div class="row hidden-md hidden-lg">
                      <div class="col-md-4">
                          <img class="img-responsive" src="assets/img/paolo.jpg" alt="Paolo Redaelli">
                      </div>
                      <div class="col-md-8">
                          <h3>Paolo Redaelli</h3>
                      </div>
                      <div class="col-md-12">
                          <p>
                              Team leader in ambito di sviluppo segue le fasi di analisi, progettazione,
                ...
                <div class="media hidden-sm hidden-xs">
                  ...
                  <div class="row hidden-md hidden-lg">
                      <div class="col-md-4">
                          <img class="img-responsive" src="assets/img/emanuele.jpg" alt="Emanuele Zappa">
                      </div>
                      <div class="col-md-8">
                          <h3>Emanuele Zappa</h3>
                      </div>
                      <div class="col-md-12">
                          <p>
                              Opera nel settore informatico da più di dieci anni con mansioni tecnico sistemistiche,
                  ...
                  <div class="media hidden-sm hidden-xs">
                      <div class="media-left">
                          <img src="assets/img/Elisa.jpg" alt="Elisa Molteni" class="media-object">
                      </div>
                      <div class="media-body">
                          <h4 class="media-heading">Elisa Molteni</h4>
                          <p>
                              <em>
                          ...
                          <p>
                              Professionista focalizzata  nella progettazione d'interni e nella concezione degli spazi per la realizzazione di
                              ambienti espositivi ricercati. Ampia visione d'insieme, ma con particolare attenzione alle specifiche tecniche e alla
                              fattibilità dei progetti. Creatività e funzionalità a disposizione del cliente, per la valorizzazione dei prodotti dell'azienda.
                          </p>
                      </div>
                  </div>
                  <div class="row hidden-md hidden-lg">
                      <div class="col-md-4">
                          <img class="img-responsive" src="assets/img/Elisa.jpg" alt="Elisa Molteni">
                      </div>
                      <div class="col-md-8">
                          <h3>Elisa Molteni</h3>
                      </div>
                  ...
                  <div class="media hidden-sm hidden-xs">
                      <div class="media-left">
                          <img src="assets/img/Nadia.jpg" alt="Nadia Bianchi" class="media-object">
                      </div>
                      <div class="media-body">
                          <h4 class="media-heading">Nadia Bianchi</h4>
                          <p>
                              <em>
                          ...
                          <p>
                              Manualità e creatività sono le sue armi principali con le quali traduce in realtà le esigenze dei clienti;
                              la costante ricerca di nuovi materiali e di nuove metodologie di utilizzo rendono le creazioni di Nadia uniche nel suo
                              genere. Sempre pronta ad accettare nuove sfide con tanto entusiasmo e grande determinazione.
                          </p>
                      </div>
                  </div>
                  <div class="row hidden-md hidden-lg">
                      <div class="col-md-4">
                          <img class="img-responsive" src="assets/img/Nadia.jpg" alt="Nadia Bianchi">
                      </div>
                      <div class="col-md-8">
                          <h3>Nadia Bianchi</h3>
                      </div>
                  ...
                  <div class="media hidden-sm hidden-xs">
                      ...
                      <div class="media-body">
                          ...
                          <p>
                              Dopo 18 mesi trascorsi in Australia nel lontano 2008, Simone appena rientrato in Italia, alle prese con il reinserimento  nel mondo del lavoro italiano,
                              si accorge che il suo hobby sta piano-piano diventando un lavoro. Così con l'inizio del 2010 inizia a svolgere a tempo pieno la professione di fotografo,
                              passione nata in giovane età, visto che il padre, fotoamatore "evoluto", lo inizia alla fine degli anni ottanta alla disciplina fotografica, e alle tecniche
                              di sviluppo e stampa in camera oscura.
                          </p>
                          <p>
                              Negli anni Simone si specializza nella fotografia di reportage, sia esso di eventi, aziendale o di viaggio. La contestualizzazione è una parte fondamentale dei suoi lavori,
                              cercando, non di realizzare una semplice foto, ma di raccontare una storia in ogni suo scatto.
                          </p>
                      </div>
                  </div>
                  <div class="row hidden-md hidden-lg">
